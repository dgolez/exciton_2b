...
mpi_lattice_step_hubbard_2b<LATTICE>::mpi_lattice_step_hubbard_2b(parameters_hub &param):
...
template <class LATTICE>
void mpi_lattice_step_hubbard_2b<LATTICE>::init_G_mat_nointeraction(void){
...
template <class LATTICE>
void mpi_lattice_step_hubbard_2b<LATTICE>::extrapolate_timestep_G(int tstp,int kt){
...
template <class LATTICE>
void mpi_lattice_step_hubbard_2b<LATTICE>::extrapolate_timestep_W(int tstp,int kt){
  // assert(tstp<=this->nt_-1);
	// extrapolate from tstp to tstp+1
	if(tstp<-1) return;
	if(tstp==-1){
...
template <class LATTICE>
void mpi_lattice_step_hubbard_2b<LATTICE>::extrapolate_timestep_D(int tstp,int kt){
  // assert(tstp<=this->nt_-1);
	// extrapolate from tstp to tstp+1
	if(tstp<-1) return;
	if(tstp==-1){
...
template <class LATTICE>
void mpi_lattice_step_hubbard_2b<LATTICE>::symmetrise_mat(GREEN &G){
	cdmatrix M,M1;
...
template <class LATTICE>
double mpi_lattice_step_hubbard_2b<LATTICE>::step(int tstp,int iter,int kt,double om0,double s,double amp){
  // assert(tstp<=this->nt_-1);
	double err;
	int n;
...
template <class LATTICE>
void mpi_lattice_step_hubbard_2b<LATTICE>::gather_gk_timestep(int tstp){
...
template <class LATTICE>
void mpi_lattice_step_hubbard_2b<LATTICE>::set_density_k(int tstp){
...
template <class LATTICE>
void mpi_lattice_step_hubbard_2b<LATTICE>::gather_Wk_timestep(int tstp){
...
template <class LATTICE>
void mpi_lattice_step_hubbard_2b<LATTICE>::gather_Dk_timestep(int tstp){
...
template <class LATTICE>
void mpi_lattice_step_hubbard_2b<LATTICE>::get_PP_Bubble(int tstp,int qq,GREEN &P){
...
template <class LATTICE>
void mpi_lattice_step_hubbard_2b<LATTICE>::get_phonon_Bubble(int tstp,int qq,GREEN &P){
  assert(tstp==gk_all_timesteps_.tstp());	
	// compute P_{a,a'}(q;t,t') on a timestep
	int qk,i1,i2,qk1,kk1;
...
template <class LATTICE>
void mpi_lattice_step_hubbard_2b<LATTICE>::get_Sigma_2b(int tstp,int kk,GREEN &S,int iter){
  assert(tstp==gk_all_timesteps_.tstp());
...
template <class LATTICE>
void mpi_lattice_step_hubbard_2b<LATTICE>::get_Gloc(int tstp){
...
template <class LATTICE>
void mpi_lattice_step_hubbard_2b<LATTICE>::get_Wloc(int tstp){
	// collect the local Greenfunction at rank with id tid
	GREEN_TSTP gtmp(tstp,this->ntau_,this->nrpa_,1);
	for(int kk=0;kk<this->latt_.nk_;kk++){
		double wt=this->latt_.kweight_bz_[kk];
...
template <class LATTICE>
void mpi_lattice_step_hubbard_2b<LATTICE>::get_Dloc(int tstp){
	// collect the local Greenfunction at rank with id tid
...
template <class LATTICE>
double mpi_lattice_step_hubbard_2b<LATTICE>::get_eneRPA(int tstp,int kt){
	cdmatrix tmp(this->nrpa_,this->nrpa_);
